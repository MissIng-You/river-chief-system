        ...
        <div class="pc-content">
            <div class="pc-statistics">
                ...
                <div v-show="patrolChart.zone && patrolChart.zone.length" v-if="isSpace" class="content-chart">
                    <patrol-chart-item :size="'small'" :item="{total: patrolChart.allReach, solve: patrolChart.patrolReach}"></patrol-chart-item>
                </div>
            ...
            <Row class="pc-charts">
                ...
                <Col span="6" class="chart-item" v-for="(item, index) in patrolChart.zone" :key="index">
                    <patrol-chart-item :item="{title: item.AreaName, subtitle: item.PhaseDescription || getPhaseName, total: item.ObjectCount, solve: item.CompleteInspectCount}"></patrol-chart-item>
                </Col>
            </Row>
        </div>
    </div>
...
import PatrolChartItem from "./PatrolChartItem";
